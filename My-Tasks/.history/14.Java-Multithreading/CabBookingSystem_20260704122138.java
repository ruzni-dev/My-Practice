...
public class CabBookingSystem {
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer(sharedCab, "Customer 1"); // Each customer thread should attempt to book the same cab.
        Customer customer2 = new Customer(sharedCab, "Customer 2"); // Each customer thread should attempt to book the same cab.
        Customer customer3 = new Customer(sharedCab, "Customer 3"); // Each customer thread should attempt to book the same cab.
