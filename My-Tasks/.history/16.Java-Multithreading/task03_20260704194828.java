...
// synchronized report writer to avoid mixed console output
class Report {
...
// thread that generates a random score for one student
class StudentThread extends Thread {
    ...
    public void run() {
        int marks = (int)(Math.random() * 101); // score from 0 to 100
...
public class task03 {
    public static void main(String[] args) {
        ...
        Report report = new Report(); // shared report object for all students
