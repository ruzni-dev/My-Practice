...
public class task04 {
    public static void main(String[] args) throws InterruptedException {
        ...
        Printer printer = new Printer(); // shared print service
        ...
        e3.setPriority(Thread.MAX_PRIORITY); // manager has higher thread priority

        e1.start();
        e2.start();
        e3.start();

        e1.join(); // wait for employee 1 to finish
        e2.join(); // wait for employee 2 to finish
        e3.join(); // wait for manager to finish
